    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="loja-filtros">
                ...
                <button class="filtro-btn" data-filtro="molduras">
                    <i class="fa-regular fa-image"></i> Molduras
                </button>
                <button class="filtro-btn" data-filtro="efeitos">
                    <i class="fa-solid fa-wand-magic-sparkles"></i> Efeitos
                </button>
            ...
            <div class="botao-secreto-container">
                <button id="botaoEstrelasSecretas" class="botao-secreto" title="Clique 5 vezes rapidamente para ganhar 10 estrelas!">
                    <i class="fa-solid fa-star"></i>
